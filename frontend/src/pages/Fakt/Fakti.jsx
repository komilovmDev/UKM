...
import UstavDocsImage3 from "../../images/ustav/fakti.png";
import UstavCatalog from "../Ustav/components/UstavCatalog";
export default function Fakti() {
  ...
  const [catalog, setCatalog] = useState([
    {
      id: 1,
      info: "№06 - 08 июль 2022 г.",
    },
    {
      id: 2,
      info: "№06 - 30.06.2021 г.",
    },
    {
      id: 3,
      info: "№08 - 08 июль 2022 г.",
    },
    {
      id: 4,
      info: "№08 - 08 июль 2023 г. ",
    },
    {
      id: 5,
      info: "№08 - 08 июль 2024 г. ",
    },
    {
      id: 6,
      info: "№08 - 08 июль 2025 г. ",
    },  
  ]);
  ...
  return (
    <div className="Ustav w-full h-full flex justify-start items-center font-rubik px-[120px] py-[60px] gap-[40px] bg-[#3D3E3D]">
      <div className="UstavContainer flex flex-col gap-[32px] w-full">
        <UstavHeader title={"Существенные факты"} />
