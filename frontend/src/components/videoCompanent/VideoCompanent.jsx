                ...
                >
                    {[...Array(5)].map((_, index) => (
                        <SwiperSlide key={index} className="custom-slide">
                            <div className={`slide-box ${index === 0 ? 'active' : ''} flex items-end relative`}>
                                <img className="w-full absolute z-0 top-0 right-0" src={newsImg} alt="" />
                                <div className="w-full z-[2] relative inset-0 bg-gradient-to-b from-transparent via-[#3D3E3D] to-[#3D3E3D] p-4 text-white">
                                    ...
                                    <p className="text-[12px]">Lorem ipsum dolor sit Nec id lacus ullamcorper enim maecenas. Sed et leo lorem senectu amet consectetur. Nec id lacus ullamcorper enim maecenas. Sed et leo lorem senectus.</p>
